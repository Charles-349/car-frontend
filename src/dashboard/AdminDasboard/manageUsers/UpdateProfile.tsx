...
const schema = yup.object({
    ...
    address: yup.string().max(50, "Max 50 characters").required("Last name is required"),
    email: yup.string().max(50, "Max 50 characters").required("Last name is required"),
    phoneNumber: yup.string().max(50, "Max 50 characters").required("Last name is required"),
