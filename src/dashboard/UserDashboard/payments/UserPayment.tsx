...
const UserPayment = () => {
  ...
  useEffect(() => {
    if (customer?.customerID) {
      trigger(customer.customerID);
    }
  }, [customer?.customerID]);

  return (
    <div className="mt-4">
      {/* If you want the user to create payments */}
      <CreatePayment />
      ...
      {isLoading && <p>Loading your payments...</p>}
      {error && <p className="text-red-500">Error fetching your payments.</p>}
